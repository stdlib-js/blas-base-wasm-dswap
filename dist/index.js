...
var V=require('@stdlib/assert-is-wasm-memory/dist'),h=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),g=require('@stdlib/utils-inherit/dist'),m=require('@stdlib/wasm-module-wrapper/dist'),j=require('@stdlib/error-tools-fmtprodmsg/dist'),z=f();function o(e){if(!(this instanceof o))return new o(e);if(!V(e))throw new TypeError(j('26lH0',e));return m.call(this,z,e,{env:{memory:e}}),this}g(o,m);h(o.prototype,"main",function(r,s,i,a,t){return this._instance.exports.c_dswap(r,s,i,a,t),a});h(o.prototype,"ndarray",function(r,s,i,a,t,v,d){return this._instance.exports.c_dswap_ndarray(r,s,i,a,t,v,d),t});E.exports=o
