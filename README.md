...
```javascript
import dswap from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-dswap@v0.0.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { Module } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-dswap@deno/mod.js';
```
